...
TEST(EditDistance, LevenshteinDistance)
{
    ...
    EXPECT_EQ(1, levenshtein("LISP", "LISp"));
    EXPECT_EQ(2, levenshtein("LISP", "LIsp"));
    EXPECT_EQ(3, levenshtein("LISP", "Lisp"));
    EXPECT_EQ(4, levenshtein("LISP", "lisp"));
    EXPECT_EQ(4, levenshtein("LISP", "lis"));
    EXPECT_EQ(4, levenshtein("LISP", "li"));
    EXPECT_EQ(4, levenshtein("LISP", "l"));
    EXPECT_EQ(4, levenshtein("LISP", ""));
    EXPECT_EQ(0, levenshtein("abcd", "abcd"));
    EXPECT_EQ(1, levenshtein("abcd", "abcD"));
    EXPECT_EQ(1, levenshtein("abcd", "Abcd"));
    EXPECT_EQ(0, levenshtein("abc", "abc"));
    EXPECT_EQ(1, levenshtein("abc", "Abc"));
    EXPECT_EQ(1, levenshtein("abc", "aBc"));
    EXPECT_EQ(1, levenshtein("abc", "abC"));
    ...
    EXPECT_EQ(1, levenshtein("A", "a"));
    EXPECT_EQ(1, levenshtein("A", "B"));
    EXPECT_EQ(1, levenshtein("Typo", "Type"));
    EXPECT_EQ(1, levenshtein("volid", "solid"));
    EXPECT_EQ(1, levenshtein("volid", "valid"));
    EXPECT_EQ(1, levenshtein("volid", "void"));
    EXPECT_EQ(3, levenshtein("volid", "voile"));
    EXPECT_EQ(1, levenshtein("volid", "vilid"));
    EXPECT_EQ(1, levenshtein("volid", "vllid"));
